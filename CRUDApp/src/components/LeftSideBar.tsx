...
const LeftSideBar = () => {
    return (
        ...
        <div className='d-flex flex-column align-items-start spacing'>
            <Link to='/' className='left-side-bar-button'>Home</Link>
            <hr className='left-side-bar-line'/> 
            <Link to='/styleboard' className='left-side-bar-button'>Style Board</Link>
            <hr className='left-side-bar-line'/>
            <Link to='/saved' className='left-side-bar-button'>Saved</Link>
            <hr className='left-side-bar-line'/>
            <Link to='/post' className='left-side-bar-button'>Post</Link>
            <hr className='left-side-bar-line'/>
        </div>
    );
}
