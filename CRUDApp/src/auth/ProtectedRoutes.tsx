...
const ProtectedRoutes: React.FunctionComponent = () => {
    ...
    // If the user is logged in, then the Outlet component will be rendered, which will render the components belonging to the protected routes (like the ones for the home page, style board page, etc).
